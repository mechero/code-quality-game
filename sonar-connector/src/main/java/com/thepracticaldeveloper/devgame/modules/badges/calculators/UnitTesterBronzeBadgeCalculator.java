...
@Component
public class UnitTesterBronzeBadgeCalculator implements BadgeCalculator {

    public static final String KEY = BadgeDetails.UNIT_TESTER_BRONZE.name();

    private static final int EXTRA_POINTS = 250;
