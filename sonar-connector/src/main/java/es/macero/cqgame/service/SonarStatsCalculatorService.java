...
@Component
final class SonarStatsCalculatorService {

	private static final Log log = LogFactory.getLog(SonarStatsCalculatorService.class);
	...
	@Autowired
	SonarStatsCalculatorService(@Value("${legacyDate}") final String legacyDateString, @Value("${coverageDate}") final String coverageDateString,
	...
	SonarStats fromIssueList(final List<Issue> issues) {
