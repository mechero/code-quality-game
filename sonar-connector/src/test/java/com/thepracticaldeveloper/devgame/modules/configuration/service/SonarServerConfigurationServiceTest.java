...
import com.thepracticaldeveloper.devgame.modules.configuration.dao.SonarServerConfigurationDao;
import com.thepracticaldeveloper.devgame.modules.configuration.domain.SonarServerConfiguration;
import com.thepracticaldeveloper.devgame.modules.configuration.domain.sonar.SonarAuthenticationResponse;
...
public class SonarServerConfigurationServiceTest {
    ...
    public void setUp() {
        ...
        config = new SonarServerConfiguration("http://localhost:9000", "token", null);
    }
